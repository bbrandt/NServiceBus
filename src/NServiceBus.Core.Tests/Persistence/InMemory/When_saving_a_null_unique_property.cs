namespace NServiceBus.SagaPersisters.InMemory.Tests
{
    ...
    class When_saving_a_null_unique_property
    {
        ...
        public void Should_throw()
        {
            ...
            Assert.AreEqual("Cannot store saga with id '895e60e0-7be3-490a-afca-fe69184474ca' since the unique property 'System.String Property' has a null value.", exception.Message);
        }
